...
let party_initialize = () => {
    ...
    let party_health_input = document.getElementById("party_health_input");
    let easy_input_button = document.getElementById("easy_input_button");
...
let retal_initialize = () => {
    ...
    let retal_health_input = document.getElementById("retal_health_input");
...
let generate_table = (object, health_level, filter = 0) => {
