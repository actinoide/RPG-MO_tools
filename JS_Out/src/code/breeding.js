...
let breeding_initialize = () => {
  ...
  <button id="breeding_input_button" class="input-button">calculate</button></div>`;
    ...
    let breeding_animal_input = document.getElementById("breeding_animal_input");
    let breeding_heart_input = document.getElementById("breeding_heart_input");
    get_stored_level("breeding").then((level) => {
        breeding_level_input.value = level.toString();
        if (breeding_level_input.value == "-1")
            breeding_level_input.value = "";
    });
