...
let mining_initialize = () => {
  ...
  <input type="number" placeholder="exp" value="" id="mining_exp_input" class="input-number" >
  <input type="number" placeholder="level" value="" id="mining_level_input" class="input-number"step = "1">
  <input type="number" placeholder="target level" value="" id="mining_target_level_input" class="input-number"step = "1">
  <input type="number" placeholder="inventory slots" value="" id="mining_inventory_input" class="input-number"step = "1">
  <label class="input-checkbox-label">
  <input type="checkbox" id="mining_2x_input" class="input-checkbox"><span class="input-checkbox-span">2x</span></label>
  <button id="mining_input_button" class="input-button">calculate</button></div>`;
    let mining_exp_input = document.getElementById("mining_exp_input");
    let mining_level_input = document.getElementById("mining_level_input");
    let mining_target_level_input = document.getElementById("mining_target_level_input");
    ...
    mining_input_button.addEventListener("click", () => {
        ...
        let xp_required = total_exp_for_level(mining_target_level_input.valueAsNumber) - (mining_exp_input.value === "" ? total_exp_for_level(mining_level_input.valueAsNumber) : mining_exp_input.value.replace(/[,]/g, ""));
