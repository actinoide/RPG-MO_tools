...
let forging_initialize = () => {
  ...
  <input type="number" placeholder="exp" value="" id="forging_exp_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;" >
  <input type="number" placeholder="level" value="" id="forging_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
  <input type="number" placeholder="target level" value="" id="forging_target_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="forging_2x_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">2x</span></label>
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="forging_smelting_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">Smelting</span></label>
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="forging_recycling_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">recycling</span></label>
  <button id="forging_input_button" style ="border-radius: 6px;height: 24px;margin-top: 10px;margin-bottom: 10px;border: none;vertical-align: top;background-color: #8777a3;color: #dddce0;padding: 5px;">calculate</button></div>`;
    let forging_exp_input = document.getElementById("forging_exp_input");
    let forging_level_input = document.getElementById("forging_level_input");
    let forging_target_level_input = document.getElementById("forging_target_level_input");
    let forging_input_button = document.getElementById("forging_input_button");
    ...
    forging_input_button.addEventListener("click", () => {
        ...
        furnace_results.forEach((value) => {
            ...
            let required = calculate_xp_recursive((forging_exp_input.value === "" ? total_exp_for_level(forging_level_input.valueAsNumber) : forging_exp_input.value.replace(/[,]/g, "")), forging_target_level_input.valueAsNumber, returns);
            let required_string = "";
        ...
        let xp_required = total_exp_for_level(forging_target_level_input.valueAsNumber) - (forging_exp_input.value === "" ? total_exp_for_level(forging_level_input.valueAsNumber) : forging_exp_input.value.replace(/[,]/g, ""));
        let forging_results = [];
        if (!forging_recycling_input.checked) {
            if (!forging_smelting_input.checked) {
                forging_formulas.forEach((value) => {
                    let forging_result = { icon_ids: [], level: 0, success: 0, xp_per_success: 0, xp_per_craft: 0, number_required: [], number_produced: { item_id: 0, count: 0 } };
                ...
                forging_formulas.forEach((value) => {
                    ...
                    value.requierments.forEach((value) => {
                        ...
                        if (!(typeof furnace_recipie === "undefined")) {
                            let required = calculate_xp_recursive((forging_exp_input.value === "" ? total_exp_for_level(forging_level_input.valueAsNumber) : forging_exp_input.value.replace(/[,]/g, "")), forging_target_level_input.valueAsNumber, furnace_recipie.returns);
