let fungiculture_initialize = () => {
  ...
  <input type="number" placeholder="exp" value="" id="fungiculture_exp_input" class="input-number" >
  <input type="number" placeholder="level" value="" id="fungiculture_level_input" class="input-number"step = "1">
  <input type="number" placeholder="target level" value="" id="fungiculture_target_level_input" class="input-number"step = "1">
  <input type="number" placeholder="Sawdust tiles" value="" id="fungiculture_sawdust_input" class="input-number"step = "1">
    <label class="input-checkbox-label">
  <input type="checkbox" id="fungiculture_spore_input" class="input-checkbox"><span class="input-checkbox-span">Spores</span></label>
   <label class="input-checkbox-label">
  ...
  let fungiculture_sawdust_input = document.getElementById("fungiculture_sawdust_input") as HTMLInputElement;
  ...
  fungiculture_input_button.addEventListener("click", () => {
    ...
    let xp_required = total_exp_for_level(fungiculture_target_level_input.valueAsNumber) - (fungiculture_exp_input.value === "" ? total_exp_for_level(fungiculture_level_input.valueAsNumber) : fungiculture_exp_input.value.replace(/[,]/g, "") as unknown as number);
    ...
    farmable.forEach((value) => {
      ...
      if (typeof spore_recipie !== "undefined" && fungiculture_spore_input.checked)
        xp_per_spore = spore_recipie?.returns[0].xp / 2;
