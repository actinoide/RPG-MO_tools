let wizardry_initialize = () => {
  ...
  <input type="number" placeholder="exp" value="" id="wizardry_exp_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;" >
  <input type="number" placeholder="level" value="" id="wizardry_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
  <input type="number" placeholder="target level" value="" id="wizardry_target_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="wizardry_2x_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">2x</span></label>
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="wizardry_spell_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">Spells</span></label>
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">  
  <input type="checkbox" id="wizardry_anvil_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">Anvil</span></label>
    <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="wizardry_recycling_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">recycling</span></label>
  <button id="wizardry_input_button" style ="border-radius: 6px;height: 24px;margin-top: 10px;margin-bottom: 10px;border: none;vertical-align: top;background-color: #8777a3;color: #dddce0;padding: 5px;">calculate</button></div>`;

  let wizardry_exp_input = document.getElementById("wizardry_exp_input") as HTMLInputElement;
  let wizardry_level_input = document.getElementById("wizardry_level_input") as HTMLInputElement;
  let wizardry_target_level_input = document.getElementById("wizardry_target_level_input") as HTMLInputElement;
  let wizardry_input_button = document.getElementById("wizardry_input_button") as HTMLButtonElement;
  let wizardry_2x_input = document.getElementById("wizardry_2x_input") as HTMLInputElement;
  let wizardry_recycling_input = document.getElementById("wizardry_recycling_input") as HTMLInputElement;
  let wizardry_spell_input = document.getElementById("wizardry_spell_input") as HTMLInputElement;
  let wizardry_anvil_input = document.getElementById("wizardry_anvil_input") as HTMLInputElement;
  ...
  wizardry_input_button.addEventListener("click", () => {
    ...
    if (wizardry_spell_input.checked) {
      spell_results.forEach((spell_result) => {
        ...
        let required = calculate_xp_recursive((wizardry_exp_input.value === "" ? total_exp_for_level(wizardry_level_input.valueAsNumber) : wizardry_exp_input.value.replace(/[,]/g, "") as unknown as number), wizardry_target_level_input.valueAsNumber, returns);
        let required_string = "";
    ...
    if (wizardry_anvil_input.checked) {
      ...
      let crafting_formulas: { product_id: number, level: number, chance: number, requierments: { item_id: number, count: number; }[], recycling_chance: number; }[] = [];
      ...
      let xp_required = total_exp_for_level(wizardry_target_level_input.valueAsNumber) - (wizardry_exp_input.value === "" ? total_exp_for_level(wizardry_level_input.valueAsNumber) : wizardry_exp_input.value.replace(/[,]/g, "") as unknown as number);

      let crafting_results: { icon_ids: number[], level: number, success: number, xp_per_success: number, xp_per_craft: number; number_required: { item_id: number, count: number; }[], number_produced: { item_id: number, count: number; }; }[] = [];
      if (!wizardry_recycling_input.checked) {
        //items without recycling  
        crafting_formulas.forEach((value) => {
          let crafting_result: { icon_ids: number[], level: number, success: number, xp_per_success: number, xp_per_craft: number; number_required: { item_id: number, count: number; }[], number_produced: { item_id: number, count: number; }; } = { icon_ids: [], level: 0, success: 0, xp_per_success: 0, xp_per_craft: 0, number_required: [], number_produced: { item_id: 0, count: 0 } };
