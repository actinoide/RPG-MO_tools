let jewelry_initialize = () => {
  ...
  let jewelry_input_button = document.getElementById("jewelry_input_button") as HTMLButtonElement;
  let jewelry_2x_input = document.getElementById("jewelry_2x_input") as HTMLInputElement;
  let jewelry_furnace_input = document.getElementById("jewelry_furnace_input") as HTMLInputElement;
  ...
  jewelry_input_button.addEventListener("click", () => {
    ...
    let xp_required = total_exp_for_level(jewelry_target_level_input.valueAsNumber) - (jewelry_exp_input.value === "" ? total_exp_for_level(jewelry_level_input.valueAsNumber) : jewelry_exp_input.value.replace(/[,]/g, "") as unknown as number);
    ...
    if (jewelry_furnace_input.checked) {
      furnace_results.forEach((value) => {
        ...
        let required = calculate_xp_recursive((jewelry_exp_input.value === "" ? total_exp_for_level(jewelry_level_input.valueAsNumber) : jewelry_exp_input.value.replace(/[,]/g, "") as unknown as number), jewelry_target_level_input.valueAsNumber, returns);
        ...
        returns[0].consumes.forEach((value) => {
          if (jewelry_recursion_input.checked) {
            ...
            if (!(typeof furnace_result === "undefined")) {
              let requiered = calculate_xp_recursive((jewelry_exp_input.value === "" ? total_exp_for_level(jewelry_level_input.valueAsNumber) : jewelry_exp_input.value.replace(/[,]/g, "") as unknown as number), jewelry_target_level_input.valueAsNumber, furnace_result.returns);
