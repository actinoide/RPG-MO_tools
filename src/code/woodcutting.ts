let woodcutting_initialize = () => {
  ...
  <input type="number" placeholder="exp" value="" id="woodcutting_exp_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;" >
  <input type="number" placeholder="level" value="" id="woodcutting_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
  <input type="number" placeholder="target level" value="" id="woodcutting_target_level_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0;min-width:40px;"step = "1">
  <input type="number" placeholder="inventory slots" value="" id="woodcutting_inventory_input" style="margin: 10px;padding: 5px;width: 15%;box-sizing: border-box;border-radius: 6px;border: none;height: 24px;background-color: #373044ff;color: #dddce0; min-width:40px;"step = "1">
  <label style="margin:10px;padding:5px;box-sizing:border-box;border:none;color:#dddce0">
  <input type="checkbox" id="woodcutting_2x_input" style="height:17px;width:17px;margin:0;vertical-align:middle;"><span style="vertical-align:middle;padding-left:5px;">2x</span></label>
  <button id="woodcutting_input_button" style ="border-radius: 6px;height: 24px;margin-top: 10px;margin-bottom: 10px;border: none;vertical-align: top;background-color: #8777a3;color: #dddce0;padding: 5px;">calculate</button></div>`;

  let woodcutting_exp_input = document.getElementById("woodcutting_exp_input") as HTMLInputElement;
  let woodcutting_level_input = document.getElementById("woodcutting_level_input") as HTMLInputElement;
  let woodcutting_target_level_input = document.getElementById("woodcutting_target_level_input") as HTMLInputElement;
  let woodcutting_inventory_input = document.getElementById("woodcutting_inventory_input") as HTMLInputElement;
  ...
  woodcutting_input_button.addEventListener("click", () => {
    ...
    let xp_required = total_exp_for_level(woodcutting_target_level_input.valueAsNumber) - (woodcutting_exp_input.value === "" ? total_exp_for_level(woodcutting_level_input.valueAsNumber) : woodcutting_exp_input.value.replace(/[,]/g, "") as unknown as number);
